...
public readonly record struct CountryCode : IScalar<CountryCode, string>
{
	private static readonly Regex VALID_COUNTRY_CODES = new(
		@"^(
	...
	public static bool TryFrom(string primitive, out CountryCode scalar) => throw new NotImplementedException();
}
