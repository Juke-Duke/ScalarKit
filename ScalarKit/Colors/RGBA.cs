...
public readonly record struct RGBA : IScalar<RGBA, string>
{
    ...
    public Percentage AlphaComponent { get; }
    ...
    public static explicit operator RGBA(HexColorCode hexColorCode)
        => new(hexColorCode.RedComponent, hexColorCode.GreenComponent, hexColorCode.BlueComponent, HexToPercentage(hexColorCode.AlphaComponent));
    ...
    private static Percentage HexToPercentage(byte hex)
        => Math.Round(hex / 255.0);
}
